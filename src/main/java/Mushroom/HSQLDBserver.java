...
public class HSQLDBserver {
    ...
    public static void init() {
        if (!initialized) {
            ...
            server = new Server();
            server.setDatabaseName(0, "mushroom_small");
            server.setDatabasePath(0, "mem:mushroom_small;sql.enforce_strict_size=true");
            server.setDatabaseName(1, "mushroom_smallext");
            server.setDatabasePath(1, "mem:mushroom_smallext;sql.enforce_strict_size=true");
